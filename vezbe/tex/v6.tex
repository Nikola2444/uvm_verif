...
\lstinputlisting[caption=v6\(\_\)test\(\_\)lib, label=lst:v6_test_lib]{code/tests/v6_calc_test_pkg.sv}
...
\lstinputlisting[caption=v6\(\_\)calc\(\_\)seq\(\_\)lib, label=lst:v6_calc_seq_lib]{code/sequences/v6_calc_seq_pkg.sv}
\lstinputlisting[caption=v6\(\_\)calc\(\_\)verif\(\_\)pkg, label=lst:v6_calc_verif_pkg]{code/v6_calc_test_pkg.sv}
